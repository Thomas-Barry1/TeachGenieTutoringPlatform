...
function RegisterPageContent() {
  ...
  useEffect(() => {
    ...
    if (errorParam === 'missing_info') {
      setError('Please complete your registration by selecting whether you are a student or tutor, then try signing in with Google again. If you continue to have issues, try using the email registration form below.')
    }
  }, [searchParams])
